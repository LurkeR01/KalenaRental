...
public class RentalRequest
{
    ...
    private RentalRequest(int carId, DateTime createdAt, string clientsName, string clientsPhoneNumber, string? comment)
    {
    ...
    public static RentalRequest Create(int carId, string clientsName, string clientsPhoneNumber, string? comment = null)
    {
        return new RentalRequest(carId, DateTime.UtcNow, clientsName, clientsPhoneNumber, comment);
    }
